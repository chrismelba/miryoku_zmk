...
&kp LCMD(Z),       &kp LCMD(X),       &kp LCMD(C),       &kp LCMD(V),       U_RDO,             &u_out_tog,        &u_bt_sel_0,       &u_bt_sel_1,       &u_bt_sel_2,       &u_bt_sel_3,       \
...
U_NA,              &kp RALT,          &kp LC(TAB),       &kp LC(SHIFT(TAB)),U_NA,              &kp INS,           &kp HOME,          &kp PG_DN,         &kp PG_UP,         &kp END,           \
